    ...
    return (
        <>
            ...
            <svg
                width="50"
                height="50"
                enableBackground="new 0 0 279.893 242.095"
                viewBox="0 0 279.893 242.095"
                xmlns="http://www.w3.org/2000/svg"
            >
                <g fillRule="evenodd">
                    <path
                        d="m124.31,241.79c67.959,0 123.81-18.618 123.81-41.334v-22.342c-5.119,29.977-85.833,40.962-123.26,40.03-53.245.27-120.46-13.69-124.37-39.66l-.186,21.97c.001,22.71 55.95,41.33 124.01,41.33z"
                        fill="#ffcc23"
                        stroke="#000"
                        strokeLinecap="round"
                    ...
                    />
                    <path
                        d="m124.4 218.14c67.866 0 123.82-18.618 123.82-41.334 0-22.714-55.949-41.239-123.82-41.239-68.051 0-124 18.524-124 41.239-3e-3 22.72 55.948 41.33 124 41.33z"
                        fill="#ffd93c"
                        stroke="#000"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <path
                        d="m124.31 215.63c64.515 0 117.67-18.062 117.67-40.03 0-22.064-53.156-40.03-117.67-40.03-64.701 0-117.76 17.966-117.76 40.03-8e-3 21.97 53.055 40.03 117.76 40.03z"
                        fill="#ffbf00"
                    />
                    <path
                        d="m124.31 213.77c61.256 0 111.71-17.596 111.71-39.1s-50.457-39.099-111.71-39.099c-61.442 0-111.9 17.594-111.9 39.099s50.454 39.1 111.9 39.1z"
                        fill="#ffcc23"
                    />
                    <path
                        d="m148.14,207.16c68.052,0 124-18.618 124-41.334v-22.342c-5.213,29.977-85.833,40.868-123.54,40.03-53.064.28-120.18-13.685-124.19-39.658l-.092,21.97c.006,22.71 55.861,41.33 123.82,41.33z"
                        fill="#ffcc23"
                        stroke="#000"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <path
                        d="m148.14 183.42c68.052 0 123.91-18.62 123.91-41.24 0-22.528-55.857-41.24-123.91-41.24-67.958 0-123.91 18.712-123.91 41.24 0 22.62 55.949 41.24 123.91 41.24z"
                        fill="#ffd93c"
                        stroke="#000"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <path
                        d="m148.14 181c64.607 0 117.76-18.06 117.76-40.03 0-21.876-53.157-40.03-117.76-40.03-64.514 0-117.67 18.154-117.67 40.03-3e-3 21.97 53.154 40.03 117.67 40.03z"
                        fill="#ffbf00"
                    />
                    <path
                        d="m148.14 179.14c61.443 0 111.81-17.688 111.81-39.098s-50.363-39.1-111.81-39.1c-61.348 0-111.8 17.688-111.8 39.1-8e-3 21.41 50.449 39.1 111.8 39.1z"
                        fill="#ffcc23"
                    />
                    <path
                        d="m136.69,169.83c67.959,0 123.82-18.617 123.82-41.239v-22.344c-5.122,29.884-85.834,40.776-123.26,39.939-53.25.278-120.46-13.686-124.37-39.566l-.186,21.97c-.007,22.62 55.942,41.24 124,41.24z"
                        fill="#ffcc23"
                        stroke="#000"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <path
                        d="m136.69 146.09c67.959 0 123.82-18.526 123.82-41.148s-55.857-41.334-123.82-41.334c-68.051 0-124 18.712-124 41.334s55.946 41.15 124 41.15z"
                        fill="#ffd93c"
                        stroke="#000"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <path
                        d="m136.69 143.67c64.515 0 117.67-18.06 117.67-39.938 0-21.97-53.155-40.124-117.67-40.124-64.7 0-117.76 18.154-117.76 40.124-7e-3 21.88 53.057 39.94 117.76 39.94z"
                        fill="#ffbf00"
                    />
                    <path
                        d="m136.69 141.81c61.256 0 111.71-17.686 111.71-39.006 0-21.504-50.458-39.192-111.71-39.192-61.442 0-111.9 17.688-111.9 39.192-1e-3 21.32 50.455 39.01 111.9 39.01z"
                        fill="#ffcc23"
                    />
                    <path
                        d="m153.63,131.57c68.052,0 124-18.526 124-41.148v-22.438c-5.12,29.975-85.832,40.96-123.44,40.124-53.157.278-120.28-13.779-124.19-39.751l-.186,22.063c.002,22.618 55.951,41.148 123.82,41.148z"
                        fill="#ffcc23"
                        stroke="#000"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <path
                        d="m153.63 108.01c68.052 0 124-18.619 124-41.24 0-22.716-55.949-41.334-124-41.334-67.958 0-123.81 18.618-123.81 41.334-4e-3 22.625 55.852 41.24 123.81 41.24z"
                        fill="#ffd93c"
                        stroke="#000"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <path
                        d="m155.59,106.62c68.052,0 124-18.618 124-41.334v-22.438c-5.214,30.07-85.927,40.962-123.54,40.124-53.06.278-120.28-13.685-124.19-39.752l-.093,22.064c.004,22.716 55.86,41.336 123.82,41.336z"
                        fill="#ffcc23"
                        stroke="#000"
                        strokeLinecap="round"
                        strokeLinejoin="round"
